...
# -*- coding: utf-8 -*-
"""
run_config_cosmics_hv_bounce.py — run_72, 2026-07-24.
BEAM-OFF cosmic scint-Singles: resist HV bounced 560 -> 530 -> 545 V at drift 600 V,
...
RESIST = [560, 530, 545]                   # card 5 ch1-4, operator's bounce order
...
if __name__ == '__main__':
    c = Config()
    out = 'config/json_run_configs/run_config_cosmics_hv_bounce.json'
    c.write_to_file(out)
    dd = c.dream_daq_info
